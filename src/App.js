...
import CryptoAddressInput from './components/CryptoAddressInput';
import CryptoCalculatorWidget from './CryptoCalculatorWidget';
...
const App = () => {
  ...
  const handleRefresh = () => {
    if (address) {
      setRefreshTimer(1); // Set timer to 10 seconds
